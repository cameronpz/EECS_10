/*********************************************************************/
/* PhotoLab_v2.c: homework assignment #3, for EECS 22,  Ref File     */
/*                                                                   */
/* Author: EECS 22 Team and Cameron Peterson-Zopf                    */
/* Date:   7/13/23                                                   */
/*                                                                   */
/*********************************************************************/
...
int main() {
    ...
    int noise = 0;          // percentage of noise
    int BlurAmount = 0;     //Blur amount
    int rbits, gbits, bbits = 0; //inputs for Posterize filter, rbits => nth LSB for red, etc.
